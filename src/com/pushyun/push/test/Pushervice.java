...
import static com.pushyun.push.utilities.CommonUtilities.DISPLAY_MESSAGE_ACTION;
import static com.pushyun.push.utilities.CommonUtilities.EXTRA_MESSAGE;
...
import com.pushyun.push.utilities.PushGlobals;
import com.pushyun.push.utilities.ServerUtilities;

public class Pushervice extends Service
{
    ...
    private void doRegisterTask()
    {
        mRegisterCMSTask = new AsyncTask<Void, Void, Void>()
        {
            ...
            {
                boolean registered = ServerUtilities.registerCMSServer(Pushervice.this, "");
                ...
                if (!registered)
                {
                    GCMRegistrar.unregister(Pushervice.this);
                }
                return null;
            }
